...
```text
We are continuing development of Assessment Studio, a multi-teacher Flask/PostgreSQL assessment platform.
...
2. Preserve PostgreSQL schema/data through versioned Alembic migrations; runtime and seed never create schema.
